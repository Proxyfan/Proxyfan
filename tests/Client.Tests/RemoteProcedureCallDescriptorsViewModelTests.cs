...
public sealed class RemoteProcedureCallDescriptorsViewModelTests
{
    ...
    private static RemoteProcedureCallDescriptorFileLibraryAdapter CreateLibrary()
    {
        var frameworkLibrary = new RemoteProcedureCallDescriptorLibrary();
        return new RemoteProcedureCallDescriptorFileLibraryAdapter(frameworkLibrary);
    }
