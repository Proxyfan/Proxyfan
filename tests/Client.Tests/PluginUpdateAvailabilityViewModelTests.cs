...
public sealed class PluginUpdateAvailabilityViewModelTests
{
    ...
    {
        var availability = new PluginUpdateAvailabilityModel(
            "com.x",
            "X plugin",
            "Author X",
            "1.0.0",
    ...
    private static PluginUpdateAvailabilityModel BuildAvailability(string current, string latest, bool isCompatible)
    {
        return new PluginUpdateAvailabilityModel(
            "com.x",
            "X",
            "A",
            current,
