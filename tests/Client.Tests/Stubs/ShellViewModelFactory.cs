...
public static class ShellViewModelFactory
{
        ...
        MutableBreakpointConfiguration breakpointConfiguration)
    {
        ...
        var trafficList = new TrafficListViewModel(eventBus, InlineUserInterfaceScheduler.Instance, requestRepeater: null, diffPool: null, clipboardService: null, coordinator);
