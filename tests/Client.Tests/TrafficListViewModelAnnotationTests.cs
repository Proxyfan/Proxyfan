...
public sealed class TrafficListViewModelAnnotationTests
{
    ...
    public async Task ApplyColorTagToSelectedCommand_WithSelection_UpdatesFlow()
    {
        ...
        await Assert.That(viewModel.GetDomainFlow(viewModel.SelectedFlow.Id)!.ColorTag).IsEqualTo(TrafficFlowColorTag.Blue);
    }
    ...
    public async Task ApplyCommentToSelectedCommand_WithSelection_UpdatesFlow()
    {
        ...
        await Assert.That(viewModel.GetDomainFlow(viewModel.SelectedFlow.Id)!.Comment).IsEqualTo("login failure repro");
    }
    ...
    public async Task ApplyCommentToSelectedCommand_WithNull_ClearsComment()
    {
        ...
        await Assert.That(viewModel.GetDomainFlow(viewModel.SelectedFlow.Id)!.Comment).IsNull();
    }
