...
public sealed class ThrottleViewModelTests
{
    ...
    public async Task Constructor_DefaultHolder_ExposesSevenPresets()
    {
        ...
        var viewModel = new ThrottleViewModel(CreateCoordinator(holder), InlineUserInterfaceScheduler.Instance, localizationService: null);
    ...
    public async Task Constructor_LocalizationServicePresent_ResolvesLocalizedPresetDisplayNames()
    {
        ...
        try
        {
            ...
            var holder = new MutableThrottleProfile();
            var viewModel = new ThrottleViewModel(CreateCoordinator(holder), InlineUserInterfaceScheduler.Instance, localizationService);
