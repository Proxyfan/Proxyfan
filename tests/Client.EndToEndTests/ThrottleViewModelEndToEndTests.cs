...
public sealed class ThrottleViewModelEndToEndTests : EndToEndTestBase
{
    ...
    public async Task Presets_FreshViewModel_ExposesAllSevenInExpectedOrder()
    {
        await RunOnUiThreadAsync(async () =>
        {
            ...
            using var vm = new ThrottleViewModel(new ThrottleProfileCoordinator(profile, InlineUserInterfaceScheduler.Instance), InlineUserInterfaceScheduler.Instance, localizationService: null);
