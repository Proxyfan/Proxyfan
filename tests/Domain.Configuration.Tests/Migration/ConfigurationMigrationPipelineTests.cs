...
public sealed class ConfigurationMigrationPipelineTests
{
    ...
    /// <summary>
    ///     A migrator that does not advance to a later version is rejected immediately.
    /// </summary>
    [Test]
    ...
    /// <summary>
    ///     A migrator that jumps beyond the requested target version is rejected immediately.
    /// </summary>
    [Test]
