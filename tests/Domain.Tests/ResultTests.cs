...
/// <summary>
///     Tests for <see cref="Result{T}" /> and <see cref="VoidResult" />.
/// </summary>
public sealed class ResultTests
{
    ...
    /// <summary>
    ///     Verifies that accessing <see cref="Result{T}.Value" /> on a failure throws.
    /// </summary>
    [Test]
    ...
    /// <summary>
    ///     Verifies that <see cref="Result{T}.Error" /> returns the provided error on failure.
    /// </summary>
    [Test]
    ...
    /// <summary>
    ///     Verifies that <see cref="Result{T}.IsSuccess" /> is false for a failure result.
    /// </summary>
    [Test]
    ...
    /// <summary>
    ///     Verifies that <see cref="Result{T}.Error" /> is null on success.
    /// </summary>
    [Test]
    ...
    /// <summary>
    ///     Verifies that <see cref="Result{T}.IsSuccess" /> is true for a success result.
    /// </summary>
    [Test]
    ...
    /// <summary>
    ///     Verifies that <see cref="Result{T}.Value" /> returns the provided value on success.
    /// </summary>
    [Test]
    ...
    /// <summary>
    ///     Verifies that <see cref="VoidResult.Error" /> returns the provided error on failure.
    /// </summary>
    [Test]
    ...
    /// <summary>
    ///     Verifies that <see cref="VoidResult.IsSuccess" /> is false for a failure result.
    /// </summary>
    [Test]
    ...
    /// <summary>
    ///     Verifies that <see cref="VoidResult.Error" /> is null on success.
    /// </summary>
    [Test]
    ...
    /// <summary>
    ///     Verifies that <see cref="VoidResult.IsSuccess" /> is true for a success result.
    /// </summary>
    [Test]
    ...
    /// <summary>
    ///     Verifies that two calls to <see cref="Result.Success()" /> return the same singleton instance.
    /// </summary>
    [Test]
