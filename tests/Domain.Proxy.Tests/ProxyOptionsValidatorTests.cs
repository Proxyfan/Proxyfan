...
/// <summary>
///     Tests for <see cref="ProxyOptionsValidator" />.
/// </summary>
public sealed class ProxyOptionsValidatorTests
{
    ...
    /// <summary>
    ///     Verifies that MaxConnections of 0 fails validation.
    /// </summary>
    [Test]
    ...
    /// <summary>
    ///     Verifies that MaxConnections of 1 passes validation.
    /// </summary>
    [Test]
    ...
    /// <summary>
    ///     Verifies that MaxConnections of -1 fails validation.
    /// </summary>
    [Test]
    ...
    /// <summary>
    ///     Verifies that port 1023 (below minimum) fails validation.
    /// </summary>
    [Test]
    ...
    /// <summary>
    ///     Verifies that port 1024 (minimum) passes validation.
    /// </summary>
    [Test]
    ...
    /// <summary>
    ///     Verifies that port 8080 (default) passes validation.
    /// </summary>
    [Test]
    ...
    /// <summary>
    ///     Verifies that port 65535 (maximum) passes validation.
    /// </summary>
    [Test]
    ...
    /// <summary>
    ///     Verifies that port 65536 (above maximum) fails validation.
    /// </summary>
    [Test]
    ...
    /// <summary>
    ///     Verifies that <see cref="ProxyOptions.ProtocolDetectionTimeout" /> of zero passes validation.
    /// </summary>
    [Test]
    ...
    /// <summary>
    ///     Verifies that a negative <see cref="ProxyOptions.ProtocolDetectionTimeout" /> fails validation.
    /// </summary>
    [Test]
