...
/// <summary>Tests for <see cref="ProxyStopped" />.</summary>
internal sealed class ProxyStoppedTests
{
    /// <summary>Verifies that <see cref="ProxyStopped.Timestamp" /> is set from the constructor.</summary>
    [Test]
    ...
    /// <summary>Verifies record equality for <see cref="ProxyStopped" />.</summary>
    [Test]
