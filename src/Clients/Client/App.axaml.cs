...
public partial class App : Application
{
    ...
    public App()
    {
        ...
        _hostBuilder.ConfigureServices((context, services) =>
        {
            ...
            {
                var innerLibrary = serviceProvider.GetRequiredService<IRemoteProcedureCallDescriptorLibrary>();
                var adapter = new RemoteProcedureCallDescriptorFileLibraryAdapter(innerLibrary);
                return adapter;
            });
