...
public partial class App : Application
{
    ...
    public App()
    {
        ...
        _hostBuilder.ConfigureServices((context, services) =>
        {
            ...
            {
                var descriptorLibrary = serviceProvider.GetRequiredService<IRemoteProcedureCallDescriptorLibrary>();
                var adapter = new RemoteProcedureCallDescriptorFileLibraryAdapter(descriptorLibrary);
                return adapter;
            });
