...
///     by host. Rebuilds from the traffic-list host snapshot exposed by the
///     shared <see cref="TrafficListCoordinator" />, and publishes a
///     host-filter request whenever the selection changes.
/// </summary>
