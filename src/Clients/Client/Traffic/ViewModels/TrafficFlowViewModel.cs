...
public sealed partial class TrafficFlowViewModel : ObservableObject
{
    ...
    /// <summary>
    ///     Gets the captured timing milestones for this flow.
    /// </summary>
    public FlowTimings Timings => _source.Timings;
    ...
    /// <summary>
    ///     Returns the underlying domain flow for infrastructure-layer coordinators.
    /// </summary>
    /// <returns>The mutable domain flow tracked for this view model.</returns>
    ...
    /// <summary>
    ///     Returns the formatted summary text for this flow.
    /// </summary>
    /// <returns>The summary text used by the inspector summary pane.</returns>
    public string GetSummaryText()
    {
        return FlowSummaryFormatter.Format(_source);
    }
