...
public sealed partial class TrafficFlowViewModel : ObservableObject
{
    ...
    /// <summary>
    ///     Updates the observable color tag on this view model.
    /// </summary>
    ...
    /// <summary>
    ///     Updates the observable comment on this view model.
    /// </summary>
    ...
    ///     (for example session persistence and diff pooling). Must not be exposed through
    ///     data bindings.
    /// </summary>
