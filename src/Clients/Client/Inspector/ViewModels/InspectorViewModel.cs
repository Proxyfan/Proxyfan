...
public sealed partial class InspectorViewModel : ObservableObject, IDisposable
{
    ...
    private void UpdateDisplayedText()
    {
        ...
        var source = selectedFlow.GetDomainFlow();
        SummaryText = FlowSummaryFormatter.Format(source);
        TimingText = FlowTimingFormatter.Format(source.Timings);
        UpdateTimingWaterfall(source.Timings);
    }
