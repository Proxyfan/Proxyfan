...
public sealed partial class PluginManagerViewModel : ObservableObject, IDisposable
{
    ...
    /// <param name="userInterfaceScheduler">The scheduler used to marshal bound-state updates onto the UI thread.</param>
    ...
    private void OnDirectoryChanged()
    {
        ...
        _userInterfaceScheduler.Post(ApplyDirectoryChange);
    }
