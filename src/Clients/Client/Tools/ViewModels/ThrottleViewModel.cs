...
/// <summary>
///     View model for the Throttle tool window. Binds to a throttle profile coordinator
...
public sealed partial class ThrottleViewModel : ObservableObject, IDisposable
{
    ...
    /// </summary>
    /// <param name="throttleProfileCoordinator">Coordinator that exposes and applies active throttle profile changes.</param>
