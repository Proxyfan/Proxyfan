...
/// <summary>
///     View model for the Allow List tool window. Binds to <see cref="MutableAllowListRule" />,
...
{
    private readonly MutableAllowListRule _rule;
    ...
    /// <summary>
    ///     Initializes a new <see cref="AllowListViewModel" /> bound to the supplied
    ...
    public AllowListViewModel(MutableAllowListRule rule, IUserInterfaceScheduler userInterfaceScheduler)
    {
        _rule = rule;
