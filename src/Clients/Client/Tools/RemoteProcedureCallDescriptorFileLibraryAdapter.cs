...
/// <summary>
///     Adapts the framework descriptor library to the presentation-safe file-library
///     abstraction used by the gRPC descriptors tool.
/// </summary>
public sealed class RemoteProcedureCallDescriptorFileLibraryAdapter : IRemoteProcedureCallDescriptorFileLibrary
{
    ...
    ///     <see cref="RemoteProcedureCallDescriptorFileLibraryAdapter" /> class.
    /// </summary>
    /// <param name="library">The underlying framework descriptor library.</param>
