...
namespace Proxyfan.Presentation.RemoteProcedureCalls;

/// <summary>
///     UI-facing catalog of loaded protobuf <c>FileDescriptorSet</c> payloads.
/// </summary>
public interface IRemoteProcedureCallDescriptorCatalog
{
    /// <summary>
    ...
    /// <summary>
    ///     Removes every loaded descriptor set and resets the catalog to an empty state.
    /// </summary>
    void Clear();
